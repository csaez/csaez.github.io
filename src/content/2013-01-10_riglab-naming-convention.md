...
*If you don't want to be too explicit you are probably looking for a way
...
specified them each time.*

* Active Rule:

*The manager expect an active rule to work with, you can set/get the
...
*We can override default values at a manager level at any time, this
becomes really handy when you're working on the same context and don't
want to be explicit about every token on every name.*
